"""SQLModel models (tables) do Postgres compartilhado — visão da Bot Lambda.

Espelham o schema do scraper (ADR 0005): a bot é dona de ``users``, ``alerts``
e ``alert_matches`` e lê ``listing`` (read-only).
"""
