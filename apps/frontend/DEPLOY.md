...
| Secret | Obrigatório | Onde achar |
| --- | --- | --- |
| `VERCEL_TOKEN` | sim | Account Settings → Tokens. Precisa poder alterar env e criar deployment neste projeto. |
| `VERCEL_PROJECT_ID` | sim | Project → Settings → General |
| `VERCEL_ORG_ID` | se o projeto estiver num time | Team Settings → General (Team ID) |
