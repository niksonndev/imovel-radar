...
export const TARGET_PROMPTS = [
  ...
  },
  {
    ...
    answer: `Sim para testar: plano free com 1 alerta. O ${PRODUCT_FACTS.pricing.pro.name} (${PRODUCT_FACTS.pricing.pro.price}${PRODUCT_FACTS.pricing.pro.period} via Pix) libera até 5 alertas e vantagens extras.`,
  },
  {
